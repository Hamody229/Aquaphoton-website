...
const sessionData = [
  // --- Bootcamps ---
  {
    ...
    date: "2026",
    description:
      "The electronics session was held as part of the Hardware Bootcamp organized by Aquaphoton Academy. The session focused on building a strong foundation in electronics and covering essential concepts.",
  },
  {
    id: 2,
    type: "Bootcamp",
    ...
    date: "2026",
    description:
      "A deep dive into professional PCB design. Participants learned how to move from schematic capture to board layout using Altium Designer, mastering routing techniques and design rules for manufacturing.",
  },
  {
    id: 5,
    type: "Bootcamp",
    ...
    date: "2026",
    description:
      "Pushing the boundaries of hardware design. This advanced session covered multi-layer stackups, high-speed signal integrity, and impedance control, preparing students for industry-standard complex boards.",
  },
  ...
  // --- Training Sessions ---
  {
    ...
    date: "2025",
    description:
      "Bridging the gap between design and reality. We covered the full fabrication process, from etching and drilling to soldering and component assembly, ensuring every board works as intended.",
  },
  {
    id: 4,
    type: "Training",
    ...
    image: "/mechanical-session.jpg",
    date: "2025",
    description:
      "Focused on the physical structure of ROVs. Students gained hands-on experience with CAD modeling, material selection, and waterproofing techniques essential for underwater robotics.",
  },
  {
    id: 6,
    type: "Training",
    ...
    date: "2025",
    description:
      "The brain behind the machine. This training introduced microcontroller programming, interrupt handling, and writing efficient C code to control hardware peripherals in real-time.",
  },
  ...
  // --- AlexDuino ---
  {
    ...
    date: "2026",
    description:
      "Part of the AlexDuino initiative: An interactive introduction to the world of circuits. Students built their first circuits, understood voltage and current, and learned how components interact.",
  },
  {
    id: 8,
    type: "AlexDuino",
    ...
    date: "2026",
    description:
      "Unlocking connectivity. We explored how devices talk to each other using UART, SPI, and I2C protocols, enabling students to interface sensors and modules with their microcontrollers.",
  },
  {
    id: 9,
    type: "AlexDuino",
    ...
    date: "2026",
    description:
      "A celebration of innovation! The Hardware Carnival brought together students to showcase their projects, compete in friendly challenges, and witness the creative potential of engineering.",
  },
...
export default function Sessions() {
  ...
  return (
    <section
      id="bootcamps"
      className="min-h-screen py-32 md:py-40 px-6 relative bg-ocean-900 overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          >
            Our <span className="text-blue-600">Highlights</span>
          </motion.h2>
        </div>
              ...
              >
                <div className="aspect-[4/3] rounded-[2rem] overflow-hidden border border-white/10 bg-white/5 relative shadow-lg group-hover:shadow-blue-900/20 transition-all duration-500 group-hover:-translate-y-2">
                  <img
                    ...
                    onError={(e) => {
                      e.target.src =
                        "https://via.placeholder.com/600x400/001d3d/3b82f6?text=Session";
                    }}
                  />
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-ocean-900 via-ocean-900/50 to-transparent opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                    <h3 className="text-white font-bold text-xl uppercase italic leading-none mb-2">
                      {item.title}
                    </h3>
