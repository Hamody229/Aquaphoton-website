  ...
  >
    <div className="w-44 h-44 md:w-52 md:h-52 bg-white/5 border border-white/10 rounded-[2rem] overflow-hidden mb-6 relative transition-all duration-500 group-hover:border-blue-500 group-hover:shadow-[0_0_30px_rgba(37,99,235,0.3)] group-hover:-translate-y-2">
      <img
        src={image}
        alt={name}
        className="w-full object-cover filter grayscale-0 md:grayscale group-hover:grayscale-0 transition-all duration-500 scale-100 group-hover:scale-110"
        onError={(e) => {
          e.target.src = "https://via.placeholder.com/400?text=Member";
        }}
      />
    ...
    <h4 className="text-white font-bold uppercase text-lg tracking-wide group-hover:text-blue-400 transition-colors">
      {name}
    </h4>
  ...
  const departments = [
    ...
    },
    {
      ...
      members: [
        ...
        {
          name: "Abdelrahman Okab",
          role: "Manipulator Head",
          image: "/okab.jpg",
        },
    ...
    },
    {
      title: "NON-Technical",
      members: [
        { name: "Ezzeldin Fekry", role: "PR Head", image: "/ezz.jpg" },
        {
          name: "Habiba Shaker",
          role: "Media Head",
          image: "/habiba.jpg",
  ...
  return (
    <section className="min-h-screen py-32 px-6 md:px-10 bg-ocean-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-black uppercase italic text-white mb-4">
